...
def main():
    ...
    parser = argparse.ArgumentParser(
        usage = "python DisplaypSCTEvent.py --datafile r1.tio --event_id 100 --image_type charge --display_hillas",
    ...
    source = EventSource(args.datafile,)
    ...
    plt.savefig(f'{args.event_id}_{args.image_type}.svg')
